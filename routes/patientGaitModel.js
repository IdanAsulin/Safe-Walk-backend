...
const { authenticate, blockNotLambda, blockNotTherapists, blockNotPatients, checkInCache } = require('../middlewares');

const router = express.Router();
const patientGaitModel = new PatientGaitModel();

router.post('/', [authenticate, blockNotPatients], patientGaitModel.createModel);
router.put('/:testID', blockNotLambda, patientGaitModel.updateModel);
